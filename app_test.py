...
def fetch_real_time_data(ticker, interval="1d", chunk_size=180, figsize=(18, 6.5), dpi=100):
    # Download data using yfinance
    data = yf.download(ticker, interval=interval, period="1d")  # Adjust period if needed
    if data.empty:
